...
export class ProfilesComponent implements OnInit {
 ...
 cities:string[]
  ...
  ngOnInit() {
    this.initForm();
   this.imagePreview="http://localhost:3000/images/hr.png"
   this.status=false;
   this.typeButton="Save"
   this.cities=["dimona","Tel-aviv","Eilat","hadera","haifa"]
   this.agies=[18,19,20,21,22,23,24,25,26]
   //this.profileService.getProfileFromBackend();
   this.profileSub =this.profileService.getProfile().subscribe(pro=>{
     this.profile={... pro}
     this.status=true;
